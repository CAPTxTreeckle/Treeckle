  ...
  return (
    <main className="dashboard">
      ...
      <Container style={{ color: "#FDFDFD" }}>
        ...
        <p>
          <strong>Note:</strong> Treeckle is currently in development as part of
          a ​
          <u>
            <strong>
              <a
          ...
          your voice heard in the future of this application, please fill up
          this{" "}
          <u>
            <strong>
              <a
          ...
          <u>
            <strong>
              <a href="mailto:admin@treeckle.com" style={{ color: "#FDFDFD" }}>
                admin@treeckle.com
              </a>
            </strong>
          </u>
